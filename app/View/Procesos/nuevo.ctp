        ...
        <div class="card">
            <div class="card-block">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Título o Referencia para tu proceso de compra</label>
                            <?php echo $this->Form->input('referencia', ['type' => 'text', 'class' => 'form-control', 'label' => false, 'div' => false]) ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Cierre de la Subasta?<span class="danger"></span></label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Detalles que sean relevantes para la oferta</label>
                            <?php echo $this->Form->input('detalles', ['type' => 'textarea', 'class' => 'form-control', 'div' => false, 'label' => false]) ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Requisitos Excluyentes para presentar una oferta.</label>
                            <div class="input-group">
