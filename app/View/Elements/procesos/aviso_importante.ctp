<div class="row m-t-10">
    <div class="col-sm-12">
        <div class="alert alert-warning">
            ...
            <ul>
                <li>Las ofertas deben ser <strong>PRECIO UNITARIO (IVA INCLUIDO)</strong>.</li>
                <!--<li>La Auto-Oferta irá aplicando <strong>descuentos de 1%</strong> hasta el valor que elijas.</li>-->
