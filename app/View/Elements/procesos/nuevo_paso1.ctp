...
<div class="card-block" id="paso1_card">
    ...
    <div class="row">
        <?php
        echo $this->element('f_input', ['params' => ['name' => 'tmp_nombre', 'label' => 'Título', 'lg' => '6', 'maxLength' => '60', 'validate']]);
        ...
        echo $this->element('f_text', ['params' => ['name' => 'tmp_especificaciones', 'label' => 'Especificaciones o Detalles especiales del producto', 'lg' => '6', 'rows' => '5', 'placeholder' => '(opcional)', 'maxLength' => '500']]);
